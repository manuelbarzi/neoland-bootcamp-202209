...
const searchHttpCats = require = require('./logic/searchHttpCats')
const authenticateUser = require('./logic/authenticateUser')
const retreiveUser = require('./logic/retrieveUser')
...
app.get('/login', (req, res) => {
    ...
    res.send(`<html>
                ...
                <body class="flex flex-col items-center">
                    <from class="flex flex-col items-center" action="/login" method="post">
...
app.get('/', (req,res) => {
    ...
    try {
        retreiveUser(userId, (error, user) => {
            if (error) {
                res.status(500)
                res.send(error.message)
