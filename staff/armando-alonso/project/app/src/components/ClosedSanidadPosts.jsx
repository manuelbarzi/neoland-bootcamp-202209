import getClosedSanidadPosts from '../logic/getClosedSanidadPosts'
import { useEffect, useState } from 'react'
import { Link } from 'react-router-dom'

const ClosedSanidadPosts = () => {
  ...
  useEffect(() => {
            try {
                getClosedSanidadPosts(sessionStorage.userId)
                  .then(posts => {
                    setNews(posts)
                    setPosts(posts)})
...
export default ClosedSanidadPosts
