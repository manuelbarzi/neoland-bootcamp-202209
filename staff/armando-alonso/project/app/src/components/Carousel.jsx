        ...
        <div className="">
            <div className="p">
                <div id="carouselExampleCaptions" className="carousel slide relative" data-bs-ride="carousel">
                    <div className="carousel-indicators rounded-lg absolute right-0 bottom-0 left-0 flex justify-center p-0 mb-4 ">
                    ...
                    <div className="carousel-inner relative w-full overflow-hidden">
                        <div className="carousel-item active relative float-left w-full">
                            <img src="https://mdbootstrap.com/img/Photos/Slides/img%20(15).jpg" className="block w-full rounded-lg" alt="..." />
                        ...
                        <div className="carousel-item relative float-left w-full">
                            <img src="https://mdbootstrap.com/img/Photos/Slides/img%20(22).jpg" className="block w-full rounded-lg" alt="..." />
                            <div className="carousel-caption hidden md:block absolute text-center">
                        ...
                        <div className="carousel-item relative float-left w-full">
                            <img src="https://mdbootstrap.com/img/Photos/Slides/img%20(23).jpg" className="block w-full rounded-lg" alt="..." />
                            <div className="carousel-caption hidden md:block absolute text-center">
