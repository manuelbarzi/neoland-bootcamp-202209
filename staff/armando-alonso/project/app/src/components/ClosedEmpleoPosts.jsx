import getClosedEmpleoPosts from '../logic/getClosedEmpleoPosts'
import { useEffect, useState } from 'react'
import { Link } from 'react-router-dom'

const ClosedEmpleoPosts = () => {
  ...
  useEffect(() => {
            try {
                getClosedEmpleoPosts(sessionStorage.userId)
                  .then(posts => {
                    setNews(posts)
                    setPosts(posts)})
...
export default ClosedEmpleoPosts
