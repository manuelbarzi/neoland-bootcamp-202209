import getClosedHaciendaPosts from '../logic/getClosedHaciendaPosts'
import { useEffect, useState } from 'react'
import { Link } from 'react-router-dom'

const ClosedHaciendaPosts = () => {
  ...
  useEffect(() => {
            try {
                getClosedHaciendaPosts(sessionStorage.userId)
                  .then(posts => {
                    setNews(posts)
                    setPosts(posts)})
...
export default ClosedHaciendaPosts
