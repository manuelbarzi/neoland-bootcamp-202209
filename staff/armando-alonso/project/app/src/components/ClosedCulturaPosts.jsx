import getClosedCulturaPosts from '../logic/getClosedCulturaPosts'
import { useEffect, useState } from 'react'
import { Link } from 'react-router-dom'

const ClosedCulturaPosts = () => {
  ...
  useEffect(() => {
            try {
                getClosedCulturaPosts(sessionStorage.userId)
                  .then(posts => {
                    setNews(posts)
                    setPosts(posts)})
...
export default ClosedCulturaPosts
