import getOpenDeportesPosts from '../logic/getOpenDeportesPosts'
import { useEffect, useState } from 'react'
import { Link } from 'react-router-dom'

const OpenDeportesPosts = () => {
    ...
    <>
        ...
        {news && news.slice(news.length-1).reverse().map(notice => 
          <div key={notice.id} className=" bg-white">
           ...
           <div key={post.id} className="flex flex-col w-full bg-white">
...
export default OpenDeportesPosts
