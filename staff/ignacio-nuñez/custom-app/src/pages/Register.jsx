...
function Register(props) {
    ...
    return <div className="flex h-full justify-center items-center bg-slate-100">
        <form onSubmit={onRegisterUser} className="w-1/4 shadow-lg shadow-slate-400 border border-2 bg-teal-300 flex flex-col gap-2 justify-center items-center p-8 rounded-lg">
            <h2 className='text-2xl font-bold'>Register</h2>
            <label htmlFor="name" className="self-start">Name</label>
            <input className="p-1 w-full rounded-lg bg-slate-100" type="text" placeholder="Input your Name" name="name" id="name" />
            <label htmlFor="email" className="self-start">E-mail</label>
            <input className="p-1 w-full rounded-lg bg-slate-100" type="email" placeholder="Input your E-mail" name="email" id="email" />
            ...
            <div className="div-register mt-2">
                ...
                <a href="" onClick={handleLoginClick} className="p-1 block text-center rounded-lg rounded-lg mt-3.5 w-full bg-slate-100">Login</a>
            </div>
        </form>
    </div>
}       
