...
function Register(props) {
    ...
    return <div className="flex h-full justify-center items-center bg-rose-700">
        <form onSubmit={onRegisterUser} className="w-1/4 shadow-xl bg-orange-500 flex flex-col gap-2 justify-center items-center p-8 border-solid border-black border-2 rounded-lg">
            ...
            <input className="p-1 w-full border-solid border-black border-2 rounded-lg bg-orange-200" type="text" placeholder="Input your Name" name="name" id="name" />
            ...
            <div className="div-register mt-2">
                ...
                <a href="" onClick={handleLoginClick} className="p-1 border-solid border-black border-2 block text-center rounded-lg rounded-lg mt-3.5 w-full bg-orange-200">Login</a>
            </div>
        </form>
    </div>
}       
