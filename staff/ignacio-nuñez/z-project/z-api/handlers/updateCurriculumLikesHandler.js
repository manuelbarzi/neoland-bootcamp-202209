...
const updateCurriculumLikes = require('../logic/updateCurriculumLikes')

module.exports = (req, res) => {
    try {
        const { userId, params: { curriculumId, offerId } } = req

        updateCurriculumLikes(userId, curriculumId, offerId)
