...
module.exports = (req, res) => {
    try {
        const { userId, params: { offerId }, body:{title, description, photo, languages, studies, experiences} } = req

        updateOffer(userId, offerId, title, description, photo, languages, studies, experiences)
