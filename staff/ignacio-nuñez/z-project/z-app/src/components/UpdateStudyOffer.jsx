                    ...
                    {studies?.map(study => {
                        return <div key={study.id} className="w-full self-start flex flex-col">
                            <div className='flex gap-1 p-1'>
                                ...
                                <textarea type="text" name="study" id="study" maxLength='55' autoFocus className="resize-none outline-none w-2/3" placeholder='Put a study here' defaultValue={study?.title}></textarea>
