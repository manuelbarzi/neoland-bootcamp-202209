...
document.onkeydown = function (event) {
  ...
  if (key === "ArrowUp" && keyPressed !== "ArrowUp") {
    ...
    crazy.move(crazy.position.x + 10, crazy.position.y);
  else if (key === "w") clown.move(clown.position.x, clown.position.y + 10);
  else if (key === "s") clown.move(clown.position.x, clown.position.y - 10);
  else if (key === "a") clown.move(clown.position.x - 10, clown.position.y);
  else if (key === "d") clown.move(clown.position.x + 10, clown.position.y);
