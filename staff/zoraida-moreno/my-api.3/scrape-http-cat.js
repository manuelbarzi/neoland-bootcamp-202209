...
xhr.onload = () => {
    ...
    //cogemos una nodeListOf (algo parecido a un array) de los divs que contienen cada gatito
    debugger;
    ...
    boxes.forEach(box => {
        ...
        // const text = box.querySelector(".Thumbnail_content_YPxza > p").textContent;
