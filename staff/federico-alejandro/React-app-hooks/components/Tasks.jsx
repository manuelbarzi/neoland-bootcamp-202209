...
function Tasks(props) {
    ...
    return <section className="mt-24 flex flex-col items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-x-44">
            <section className="flex flex-col h-fit rounded-lg gap-2 w-72 border-4 p-2">
            ...
            <section className="flex flex-col h-fit border-4 rounded-lg w-72 p-2 gap-2">
            ...
            <section className="border-4 h-fit rounded-lg w-72 p-2 gap-2">
