function Login(props) {
    ...
    const handleSubmit = event => {
        ...
        const emailInput = form.email // accedo al email atraves de 'name'
    ...
    return <main className="flex flex-col  items-center gap-2">
        <div className=" flex flex-col items-center  gap-6 border-5 border-stone-900 h-96 mt-44">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-60 p-7 bg-indigo-600 rounded-lg h-80 shadow-2xl shadow-gray-900">
                ...
                <input name="password" type="password" id="password" placeholder=" input a password" className="bg-slate-300 border-b border-black rounded-md" />
