                ...
                return Aliens.find({})
                    .then(aliens => {
                        ...
                        return GameAliens.create({
                            ...
                            }, attacks: [picks[0]._doc.atack1, picks[0]._doc.atack2, picks[0]._doc.atack3, picks[0]._doc.atack4], passives: [""], player: userId
                        },

                            {
                                ...
                                attacks: [picks[1]._doc.atack1, picks[1]._doc.atack2, picks[1]._doc.atack3, picks[1]._doc.atack4], passives: [""], player: userId
                            },

                            {
                                ...
                                attacks: [picks[2]._doc.atack1, picks[2]._doc.atack2, picks[2]._doc.atack3, picks[2]._doc.atack4], passives: [""], player: userId
                            },

                            {
                                ...
                                attacks: [picks[3]._doc.atack1, picks[3]._doc.atack2, picks[3]._doc.atack3, picks[3]._doc.atack4], passives: [""], player: userId
                            },

                            {
                                ...
                                attacks: [picks[4]._doc.atack1, picks[4]._doc.atack2, picks[4]._doc.atack3, picks[4]._doc.atack4], passives: [""], player: userId
                            },
                            ...
                            return Game.findOneAndUpdate({ players: userId, aliensPlayerOne: [gameAliens[0]._id, gameAliens[1]._id, gameAliens[2]._id, gameAliens[3]._id, gameAliens[4]._id, gameAliens[5]._id] }).then({
