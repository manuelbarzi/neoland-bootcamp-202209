                ...
                return Aliens.find({})
                    .then(aliens => {
                        ...
                        return GameAliens.create({
                            ...
                            }, attacks: [picks[0]._doc.atack1, picks[0]._doc.atack2, picks[0]._doc.atack3, picks[0]._doc.atack4], passives: [""], player: game.players[0]
                        },
                            {
                                ...
                                attacks: [picks[1]._doc.atack1, picks[1]._doc.atack2, picks[1]._doc.atack3, picks[1]._doc.atack4], passives: [""], player: game.players[0]
                            },
                            {
                                ...
                                attacks: [picks[2]._doc.atack1, picks[2]._doc.atack2, picks[2]._doc.atack3, picks[2]._doc.atack4], passives: [""], player: game.players[0]
                            },
                            {
                                ...
                                attacks: [picks[3]._doc.atack1, picks[3]._doc.atack2, picks[3]._doc.atack3, picks[3]._doc.atack4], passives: [""], player: game.players[0]
                            },
                            {
                                ...
                                attacks: [picks[4]._doc.atack1, picks[4]._doc.atack2, picks[4]._doc.atack3, picks[4]._doc.atack4], passives: [""], player: game.players[0]
                            },
                            {
                                ...
                                attacks: [picks[5]._doc.atack1, picks[5]._doc.atack2, picks[5]._doc.atack3, picks[5]._doc.atack4], passives: [""], player: game.players[1]
                            },
                            {
                                ...
                                attacks: [picks[6]._doc.atack1, picks[6]._doc.atack2, picks[6]._doc.atack3, picks[6]._doc.atack4], passives: [""], player: game.players[1]
                            },
                            {
                                ...
                                attacks: [picks[7]._doc.atack1, picks[7]._doc.atack2, picks[7]._doc.atack3, picks[7]._doc.atack4], passives: [""], player: game.players[1]
                            },
                            {
                                ...
                                attacks: [picks[8]._doc.atack1, picks[8]._doc.atack2, picks[8]._doc.atack3, picks[8]._doc.atack4], passives: [""], player: game.players[1]
                            },
                            {
                    ...
                    throw new TypeError('Searching player')
                }
        })
}
